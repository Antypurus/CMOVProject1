...
\subsubsection{Checkout}
\hspace{0.6cm}
\includegraphics[width=0.5\linewidth]{Images/StoreMenu.jpg}

\subsection{Client Application}

\subsubsection{User Registering}
\hspace{0.6cm}
\includegraphics[width=0.3\linewidth]{Images/Client/ClientRegister.jpg}
...
\hspace{0.6cm}
\includegraphics[width=0.3\linewidth]{Images/Client/ClientTransactionHistory.jpg}

\subsubsection{Viewing Products Bough In Past Transaction}
\hspace{0.6cm}
\includegraphics[width=0.3\linewidth]{Images/Client/ClientTransaction.jpg}

\subsubsection{Viewing Vouchers Available To User And Amount Of Money Usable For Discounting}
\hspace{0.6cm}
\includegraphics[width=0.3\linewidth]{Images/Client/ClientVoucherList.jpg}

\subsubsection{Checkout}
\hspace{0.6cm}
\includegraphics[width=0.3\linewidth]{Images/Client/ClientCheckout.jpg}
