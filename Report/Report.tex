...
\begin{itemize}
	\item products - 
	\item user\textunderscore id - 
	\item use\textunderscore discount - 
	\item sign - 
	\item voucher\textunderscore id - 
\end{itemize}
...
\hspace{0.6cm}
The user can generate a checkout QR code that he can validate in the store application to execute his purchase.
